...
class FatsScreen extends StatefulWidget {
  const FatsScreen({Key? key}) : super(key: key);
  static const String id = "FatsScreen";
  @override
  State<FatsScreen> createState() => _FatsScreenState();
}
...
class _FatsScreenState extends State<FatsScreen> {
  ...
  Future getInfo() async {
    _nutritionList =
        await FireStoreServices().getNutritionForTrainerHomeScreen("Fats");
