...
class CarbohydratesScreen extends StatefulWidget {
  const CarbohydratesScreen({Key? key}) : super(key: key);
  static const String id = "CarbohydratesScreen";
  @override
  State<CarbohydratesScreen> createState() => _CarbohydratesScreenState();
}

class _CarbohydratesScreenState extends State<CarbohydratesScreen> {
  List<Nutrition> _nutritionList = [];

  Future getInfo() async {
    _nutritionList = await FireStoreServices()
        .getNutritionForTrainerHomeScreen("Carbohydrates");
